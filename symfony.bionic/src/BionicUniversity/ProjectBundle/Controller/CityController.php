...
use BionicUniversity\ProjectBundle\Entity\City;
use BionicUniversity\ProjectBundle\Form\CityType;
...
class CityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BionicUniversityProjectBundle:City')->findAll();

        return $this->render('BionicUniversityProjectBundle:City:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('BionicUniversityProjectBundle:City:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BionicUniversityProjectBundle:City')->find($id);
        ...
        return $this->render('BionicUniversityProjectBundle:City:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BionicUniversityProjectBundle:City:edit.html.twig', array(
            'entity'      => $entity,
